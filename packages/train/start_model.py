...
from packages.models.gcn import GCN
from packages.models.gru import GRU 
from packages.models.tgcn import TGCN
from packages.models.a3t_gcn import TGCNAttention
...
def initialization(model_name, trainX, trainY, testX, testY, adj, learning_rate, gru_units, seq_len, pre_len, training_epoch, totalbatch, batch_size, num_nodes, device):
    ...
    if model_name == 'TGCN':
        ...
        y_pred, test_rmse, test_wmape = train(trainX, trainY, testX, testY, 
                                                            clf_nn=TGCN_module, 
                                                            criterion=mse_loss, 
                                                            optimizer=optimizer,
