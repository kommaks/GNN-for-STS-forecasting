python main.py --train True --evaluate True --dataset atm_transactions --window_size 12 --horizon 3 --norm_method ьшт_ьфч --train_length 7 --valid_length 2 --test_length 1 --device cuda:0
